...
window.addNewList = (id) => {
  ...
  if (window.validateText(textList)) {
    ...
    <div id="listBox${id}" class="d-inline-block numDivs listBox">
      <div id="listText"><strong id="breakWord">${textList}</strong></div>
...
//FUNCION PARA AÑADIR NUEVA TARJETA DENTRO DE LISTA
